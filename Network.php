...
use pocketmine\network\protocol\AhddItemEntityPacket;
...
class Network {
	...
	private function registerPackets310() {
		...
		$this->registerPacket310(ProtocolInfo310::CHANGE_DIMENSION_PACKET, ChangeDimensionPacket::class);
		$this->registerPacket310(ProtocolInfo310::CLIENTBOUND_MAP_ITEM_DATA_PACKET, MapItemDataPacket::class);
	...
	private function registerPackets331() {
		...
		$this->registerPacket331(ProtocolInfo331::CHANGE_DIMENSION_PACKET, ChangeDimensionPacket::class);
		$this->registerPacket331(ProtocolInfo331::CLIENTBOUND_MAP_ITEM_DATA_PACKET, MapItemDataPacket::class);
    	...
    	$this->registerPacket331(ProtocolInfo331::BOSS_EVENT_PACKET, BossEventPacket::class);
