...
use pocketmine\block\{Block, Fire, Portal};
...
use pocketmine\network\protocol\{SetTimePacket, ChangeDimensionPacket, PlayStatusPacket};
...
abstract class Entity extends Location implements Metadatable{
    ...
    const DATA_FLAG_BLOCKING = 71; //shield
...
//		$this->setDataProperty(self::DATA_AIR, self::DATA_TYPE_SHORT, $this->namedtag["Air"]);
	 ...
	 * @param bool $force
	 */
	public function setItem($key, $value, $force = false){
		$this->setDataProperty($key, Entity::DATA_TYPE_SLOT, $value, $force);
	}
	...
	public static function createBaseNBT(Vector3 $position, Vector3 $motion, $yaw, $pitch){
        return new Compound("", [
            "Pos" => new Enum("Pos", [
