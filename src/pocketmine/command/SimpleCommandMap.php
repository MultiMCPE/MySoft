...
use pocketmine\command\defaults\PInfoCommand;
use pocketmine\command\defaults\PingListCommand;
...
class SimpleCommandMap implements CommandMap{
	...
	private function setDefaultCommands(){
		...
		$this->register("pocketmine", new VersionCommand("about"));
		...
		$this->register("pocketmine", new WhitelistCommand("wl"));
		...
		$this->register("pocketmine", new PingListCommand("pinglist"));
                $this->register("pocketmine", new PInfoCommand("pinfo"));
	}
	...
	public function register($fallbackPrefix, Command $command, $label = null){
		...
		array_push($this->commands, $label);
	...
	public function killCommand(Command $command, $fallbackPrefix, $label){
		$this->unregister($command);
		unset($this->knownCommands[$fallbackPrefix . ":" . $label]);
	}
