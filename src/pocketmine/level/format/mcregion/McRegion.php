...
class McRegion extends BaseLevelProvider{
	...
	public static function generate($path, $name, $seed, $generatorName, array $options = []){
		if(!file_exists($path)){
		...
		$levelData = new Compound("Data", [
			...
			"generatorName" => new StringTag("generatorName", Generator::getGeneratorName($generatorName)),
