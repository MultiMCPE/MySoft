...
class AvailableCommandsPacket extends PEPacket{
	...
	public static function prepareCommands($commands) {
		...
		$commandsStreams = [
			...
			Info::PROTOCOL_401 => new BinaryStream(),
			...
			Info::PROTOCOL_425 => new BinaryStream(),
			Info::PROTOCOL_428 => new BinaryStream(),
			Info::PROTOCOL_431 => new BinaryStream(),
			Info::PROTOCOL_440 => new BinaryStream(),
			Info::PROTOCOL_448 => new BinaryStream(),
			Info::PROTOCOL_455 => new BinaryStream(),
			Info::PROTOCOL_459 => new BinaryStream(),
			Info::PROTOCOL_465 => new BinaryStream(),
			Info::PROTOCOL_471 => new BinaryStream(),
		];
