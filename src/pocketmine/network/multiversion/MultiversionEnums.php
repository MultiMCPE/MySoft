...
abstract class MultiversionEnums {
	...
	public static $particleIds = [
		Info::PROTOCOL_448 => [
			...
			"TYPE_LARGE_EXPLODE" => 16,
			"TYPE_HUGE_EXPLODE" => 17,
			"TYPE_MOB_FLAME" => 18,
			"TYPE_HEART" => 19,
			"TYPE_TERRAIN" => 20,
			"TYPE_TOWN_AURA" => 21,
			"TYPE_PORTAL" => 22,
			"TYPE_WATER_SPLASH" => 24,
			"TYPE_WATER_WAKE" => 26,
			"TYPE_DRIP_WATER" => 27,
			"TYPE_DRIP_LAVA" => 28,
			"TYPE_DUST" => 32,
    ...
    public static function getParticleArray($protocol){
		switch ($protocol) {
		    case Info::PROTOCOL_440:
		    case Info::PROTOCOL_431:
		        return self::$particleIds[Info::PROTOCOL_431];
			case Info::PROTOCOL_428:
		    case Info::PROTOCOL_423:
		    case Info::PROTOCOL_422:
			case Info::PROTOCOL_419:
			...
			case Info::PROTOCOL_389:
			case Info::PROTOCOL_388:
			    return self::$particleIds[Info::PROTOCOL_389];
			case Info::PROTOCOL_387:
		    case Info::PROTOCOL_386:
			case Info::PROTOCOL_385:
			case Info::PROTOCOL_371:
			...
			case Info::PROTOCOL_361:
			case Info::PROTOCOL_360:
			    return self::$particleIds[Info::PROTOCOL_360];
			case Info::PROTOCOL_354:
			case Info::PROTOCOL_351:
			case Info::PROTOCOL_350:
			case Info::PROTOCOL_342:
			...
			case Info::PROTOCOL_120:
			case Info::PROTOCOL_110:
				return self::$particleIds[Info::PROTOCOL_110];
			default:
				return self::$particleIds[Info::PROTOCOL_448];
		}
    }
