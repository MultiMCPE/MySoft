...
class InventoryType{
	...
	const DROPPER = 11;
	const HOPPER = 12;
	const SHULKER_BOX = 13; //by ssss1
	const ENDER_CHEST = 21;
	const BEACON = 20; //by ssss1
	...
	public static function init(){
		...
		static::$default[static::SHULKER_BOX] = new InventoryType(27, "Shulker Box", self::TYPE_CONTAINER);
